    ...
    <>
      ...
      <div className='custom-container'>
        <div className="pt-10 md:pt-20 pb-7">
          <h2 className="md:text-[24px] text-[16px] font-[600] text-[#996830cc] sm:ml-28 leading-[20px] tracking-widest">
            <span className="border-t-2 border-[#996830cc] w-14 inline-block mr-2 mb-1.5 "></span>
            Estimate Selection : Premium/Luxury
          </h2>
        </div >
        <div>
          <div className='flex md:flex-row flex-col justify-center items-center my-10 gap-10'>
            <div className='border-4 border-[#99683033] md:py-16 md:px-10 py-8 px-5 rounded-lg shadow-lg shadow-white'>
              <h2 className='text-[#444] md:text-[32px] font-[700] text-[18px] md:leading-[72px] text-center font-Playfair mb-10'>Premium</h2>
              ...
              <div className='text-center'>
                <button
                  ...
                  ${selectedType === "premium" ?
                      "bg-[#996830] text-[#fff] " : "bg-[#9968301A] text-[#996830]"}`}>
          ...
          <div className="flex flex-col justify-center items-center mb-10">
            <div className='flex  justify-center md:items- items-start my-8 text-[#444]'>
              <input
                type="checkbox"
