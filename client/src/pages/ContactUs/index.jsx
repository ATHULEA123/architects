...
const Contactus = () => {
    return (
        <>
          <Header className="container ant-header flex-row items-center " style={{ padding: 0}}>
            ...
            <div
                className="flex flex-col px-4 sm:px-8 md:px-12 py-10 min-h-screen w-full bg-cover"
                style={{
