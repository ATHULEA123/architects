...
const Portfolio = () => {
  ...
  return (
    <div className="custom-container mt-15">
      <div className="">
        <div id="portfolio">
      ...
      >
        ...
        as="div"
        onChange={(inView) => {
          setTriggerCount(inView); // Trigger animation when entering, reset when exiting
        }}
      >
        <div className="ads text-6xl font-normal">
          {triggerCount && (
          ...
          {!triggerCount && "3469"} {/* Display static 100% when not animating */}
        </div>
      </InView>
            <div>
